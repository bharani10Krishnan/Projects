...
public class UtilityClass {
	...
	public String getProperty(String key) throws IOException {
		...
		FileInputStream fis = new FileInputStream("C:\\Users\\2261164\\eclipse-workspace\\FlipKartWebsiteCu\\src\\test\\resources\\config.properties");
	...
	public String takeScreenshot(String fileName) throws IOException{
		...
		File destFile=new File("./FlipkartProjectScreenshots/"+fileName+".png");
